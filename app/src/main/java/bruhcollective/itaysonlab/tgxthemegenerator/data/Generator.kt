package bruhcollective.itaysonlab.tgxthemegenerator.data
...
object Generator {
  ...
  private fun StringBuilder.appendMeta(ctx: Context) = apply {
    appendLine("!")
    appendLine("name: \"${ctx.resources.getString(R.string.app_name)}'s generated theme\"")
    appendLine("author: \"iTaysonLab\"")
  }

  private fun StringBuilder.appendProps(ctx: Context) = apply {
    appendLine("@")
